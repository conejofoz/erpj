            ...
            <menu>	
                <dl>
                    ...
                    <ul class="sessao">
                        ...
                        <dd>
                            <ul>
                                <li><a href="<?php echo URL_BASE . "produto" ?>">Produto</a></li>
                                <li><a href="<?php echo URL_BASE . "categoria" ?>">Categoria</a></li>
                                <li><a href="<?php echo URL_BASE . "subcategoria" ?>">Subcategoria</a></li>
                                <li><a href="<?php echo URL_BASE . "grupo" ?>">Grupo</a></li>
                                <li><a href="<?php echo URL_BASE . "subgrupo" ?>">SubGrupo</a></li>
                                <li><a href="<?php echo URL_BASE . "marca" ?>">Marca</a></li>
                                <li><a href="<?php echo URL_BASE . "modelo" ?>">Modelo</a></li>
                            </ul>
                        </dd>
                        </li>			
